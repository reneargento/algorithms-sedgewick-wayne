...
public class Exercise47_RandomSparseDigraphs {
    ...
    public static void main(String[] args) {
        List<DigraphInterface> randomSparseDigraphs = new Exercise47_RandomSparseDigraphs().randomSparseDigraph(10);
        StdOut.println("Random sparse digraphs generated: " + (randomSparseDigraphs.size() > 0));
    }
