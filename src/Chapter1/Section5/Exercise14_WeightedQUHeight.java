...
public class Exercise14_WeightedQUHeight {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Components: " + weightedQuickUnionByHeight.count() + " Expected: 3");
        System.out.println("Maximum height: " + weightedQuickUnionByHeight.maxHeight + " Expected: Equal or less than 5 for N = 19" +
                " (lg 19 = 5)");
    }
