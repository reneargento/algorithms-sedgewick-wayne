...
public class Exercise45_ActualTimings {
    ...
    public static void main(String[] args) {
        ...
        Exercise45_ActualTimings actualTimings = new Exercise45_ActualTimings();
        String title;
...
//        actualTimings.frequencyCounter(binarySearchSymbolTable, wordsInTale, minLength, title);
        ...
        title = "BST running time calling get() or put() in FrequencyCounter";
        actualTimings.frequencyCounter(binarySearchTree, wordsInTale, minLength, title);
    }
